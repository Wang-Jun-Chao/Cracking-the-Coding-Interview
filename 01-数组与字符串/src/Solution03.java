...
/**
 * 给定两个字符串， 请编写程序， 确定真申一个争可串的字待重新排列后． 能否变成另
 * 一个字符串。
 * 跟其他许多问题一样， 首先我们应该向面试官确认一些细节，弄清楚变位词
 * （ anagram : 变位词是由变扶某个词或短鼠的字母顺序而构成的新的词或短诵）
 * 比较是否区分大小写。比如， God是否为dog的变位·词？此外，我们还应该问清楚是否要考虑空白
...
public class Solution03 {
    ...
    /**
     * 解法2：检查两个字符凛的各字符数是否相同，前提是输入的字符只是ASCII
